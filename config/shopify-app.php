...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'UpSolite: Bulk Invite & Login'),
    ...
    */
    ...
    'listen' => [
        ...
        \Osiset\ShopifyApp\Messaging\Events\PlanActivatedEvent::class => [
            \App\Listeners\HandlePlanActivation::class,
        ],
    ],
    ...
    */
    ...
    'webhooks' => [
        ...
        [
            'topic' => 'SHOP_UPDATE',
            'address' => "$baseUrl/webhook/shop-updated"
        ],
        [
            'topic' => 'BULK_OPERATIONS_FINISH',
            'address' => "$baseUrl/webhook/bulk-operations-finished"
        ],
        [
            'topic' => 'CUSTOMERS_ENABLE',
            'address' => "$baseUrl/webhook/customer-enabled"
        ],
        [
            'topic' => 'CUSTOMERS_DISABLE',
            'address' => "$baseUrl/webhook/customer-disabled"
        ],
        [
    ...
    /*mandatory webhooks
     * $baseUrl/webhook/shop-redact
     * $baseUrl/webhook/customers-redact
     * $baseUrl/webhook/customers-data-request
     *
     */
    ...
    */
    ...
    'job_queues' => [
        'webhooks' => env('WEBHOOKS_JOB_QUEUE', 'shopify'),
